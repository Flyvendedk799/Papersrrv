...
export const GLOSSARY: Record<GlossaryTerm, GlossaryEntry> = {
  ...
  matter: {
    ...
    long: "Everything in Boared is a matter — a task, an issue, a question. Each matter has its own case file with its own status, owners, runs and history.",
  },
  ancestor: {
    title: "Parent matter",
  ...
  board: {
    ...
    long: "Boared treats the human operator as the board of directors for a company of AI agents. You set direction, approve big moves, and unblock things agents can't decide themselves.",
  },
  priority_critical: {
