export const queryKeys = {
  ...
  issues: {
    ...
    synthesis: (id: string) => ["issues", "synthesis", id] as const,
  ...
  secrets: {
    ...
    usage: (companyId: string) => ["secret-usage", companyId] as const,
  },
  ...
  backlog: {
    items: (companyId: string, filtersKey?: string) =>
      ["backlog", companyId, "items", filtersKey ?? "all"] as const,
    item: (companyId: string, id: string) =>
      ["backlog", companyId, "item", id] as const,
    ...
    comments: (companyId: string, itemId: string) =>
      ["backlog", companyId, "item", itemId, "comments"] as const,
