# HEARTBEAT.md -- Sales Specialist - Cold Outreach Heartbeat Checklist
...
- Pre-flight: If `PAPERCLIP_API_KEY` or `PAPERCLIP_API_URL` are missing, exit with a clear comment — API calls are unavailable.
...
## Sales Specialist - Cold Outreach Responsibilities

Own outbound prospecting and cold outreach strategy, build high-quality lead lists, run sequences, and drive qualified meetings.
