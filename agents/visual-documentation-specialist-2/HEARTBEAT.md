# HEARTBEAT.md -- Visual Documentation Specialist 2 Heartbeat Checklist
...
## Visual Documentation Specialist 2 Responsibilities

Create diagrams, flowcharts, architecture visuals, and visual documentation that complements technical docs.
