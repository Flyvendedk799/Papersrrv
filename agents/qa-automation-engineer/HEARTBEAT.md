# HEARTBEAT.md -- QA Automation Engineer Heartbeat Checklist
...
Own automated testing strategy, regression prevention, reliability checks, and release quality gates across server and UI
